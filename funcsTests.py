...
class TestCases(unittest.TestCase):
   ...
   def test_earthquakes_equal_2(self):
      quake1 = Earthquake('12km SSW of Idyllwild, CA', 0.87, -116.7551651, 33.6391678, 1488177290)
      quake2 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177290)
      self.assertNotEqual(quake1, quake2)

   def test_earthquakes_equal_3(self):
      quake1 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177290)
      quake2 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -115.7551651, 33.6391678, 1488177290)
      self.assertNotEqual(quake1, quake2)

   def test_earthquakes_equal_4(self):
      quake1 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177290)
      quake2 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 34.6391678, 1488177290)
      self.assertNotEqual(quake1, quake2)

   def test_earthquakes_equal_5(self):
      quake1 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177290)
      quake2 = Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177291)
      self.assertNotEqual(quake1, quake2)
   ...
   def test_filter_by_mag_1(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, CA', 1, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 3, -155.2835, 58.1548, 1488219604))
      filtered = []
      filtered.append(Earthquake('12km SSW of Idyllwild, CA', 1, -116.7551651, 33.6391678, 1488177290))
      filtered.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
      filtered.append(Earthquake('100km SE of King Salmon, Alaska', 3, -155.2835, 58.1548, 1488219604))
      self.assertEqual(filter_by_mag(quakes, 1, 3), filtered)

   def test_filter_by_mag_2(self):
      quakes = []
      quakes.append(Earthquake('12km SSW of Idyllwild, CA', 1.000001, -116.7551651, 33.6391678, 1488177290))
      quakes.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 5.1, -155.2835, 58.1548, 1488219604))
      quakes.append(Earthquake('100km SE of King Salmon, Alaska', 2.9999, -155.2835, 58.1548, 1488219604))
      filtered = []
      filtered.append(Earthquake('12km SSW of Idyllwild, CA', 1.000001, -116.7551651, 33.6391678, 1488177290))
      filtered.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
      filtered.append(Earthquake('100km SE of King Salmon, Alaska', 2.9999, -155.2835, 58.1548, 1488219604))
      self.assertEqual(filter_by_mag(quakes, 1, 3), filtered)
   ...
   def test_filter_by_place_2(self):
      ...
      filtered = []
      filtered.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
      self.assertEqual(filter_by_place(quakes, "gil"), filtered)
   ...
   def test_filter_by_place_4(self):
      ...
      filtered = []
      filtered.append(Earthquake('100km SE of King Salmon, Alaska', 1.9, -155.2835, 58.1548, 1488219604))
      self.assertEqual(filter_by_place(quakes, "ALA"), filtered)
